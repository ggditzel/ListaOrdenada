...
public static void main(String[] args) {
	...
	Aluno buscado;
		...
		Aluno a3 = null;
		Aluno a4 = null;
		Aluno desconhecido = null;
		try {
			a1 = new Aluno("Jose");
			a2 = new Aluno("Joao");
			a3 = new Aluno("Silvio");
			a4 = new Aluno("Paulo");
			desconhecido = new Aluno("Ninguem");
//			l1.inserirFinal(a4);
//			l1.inserirFinal(a1);
//			l1.inserirFinal(a3);
//			l1.inserirFinal(a2);
			...
			l1.inserirPosAtual(desconhecido);
...
//			System.out.printf("Aluno encontrado pelo codigo: %s; matricula: %d; cursor: %s\n", buscado.getNome(), buscado.getCodigo(), buscado);
//		} catch (Exception e1) {
...
//	}
		...
		try {
			buscado = l1.buscar3(a3).getElemento();
			System.out.printf("Aluno encontrado: %s; matricula: %d; cursor: %s\n", buscado.getNome(), buscado.getCodigo(), buscado);
		} catch (Exception e1) {
			System.out.println(e1);
		}
